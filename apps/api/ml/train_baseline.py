"""
EconoSphere AI -- Phase 11, Step 5: Baseline ML Training & Evaluation
======================================================================
...
Outputs  : models/phase11/  (trained models + metadata)
           docs/phase11/baseline_ml_training_report.md
           docs/phase11/plots/  (actual-vs-predicted plots)

Run from the project root:
    python apps/api/ml/train_baseline.py
...
def write_report(
    ...
    repro_section = (
        ...
        f"Running `python apps/api/ml/train_baseline.py` twice with the same "
...
def main() -> None:
    ...
    # 9. Metadata
    save_metadata(
        best_name, all_metrics, n_train, n_val, n_test, n_countries, saved_models
    )
